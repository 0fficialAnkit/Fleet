...
struct MaintenanceTask: Codable, Identifiable, Hashable, Sendable {
    let id: Int
    var vehicleId: Int // FK
    var scheduledBy: Int? // FK
    var assignedTo: Int? // FK
